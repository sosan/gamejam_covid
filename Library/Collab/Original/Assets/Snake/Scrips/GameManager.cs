...
namespace SA
{
    ...
    private Vector2Int gridPosition;
        ...
        void CreateApple()
        {
            ...
            appleRenderer.sprite = diamondSprite;
        ...
        void SetPlayerDirection()
        {
            ...
            transform.eulerAngles = new Vector3(0, 0, /*GetAngleFromVector(gridMoveDirection) +*/ offset);
            print("angulo="  + transform.eulerAngles + " grid=" + gridMoveDirection);
        ...
        Sprite CreateSprite(Color targetColor)
        {
            ...
            return Sprite.Create(txt, rect, Vector2.one * .5f, 1, 0, SpriteMeshType.FullRect); //Bug
        }

        void RandomlyPlaceApple() 
        {
            int ran = Random.Range(0, avaliableNodes.Count);
            Node n = avaliableNodes[ran];
